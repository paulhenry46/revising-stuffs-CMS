...
<x-post-card :post=$post :starred=false description=false showGroup=false/>
                                ...
                                @empty
                                <div class="col-span-4 rounded-box mt-6 dark:border-gray-500 border-base-300 dark:text-gray-500 text-base-content/30 flex h-72 flex-col items-center justify-center gap-6 border-2 border-dashed p-10 text-center [text-wrap:balance]">
