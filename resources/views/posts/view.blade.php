                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div class="col-span-3 lg:col-span-2">
                                ...
                                @endif
                                    ...
                                    @endif
                                @empty
                                <div class=" text-lg  pt-6 text-center">
                            ...
                            <div class="col-span-3 lg:col-span-1">
                                ...
                                <div class="pt-6">
                                    ...
                                    @endif
                                            ...
                                            @if(!empty($post->user->license)) {{__('His/her posts are licensed under')}} {{$post->user->license}}@else {{__('This user didn\'t chose a license for his/her posts')}} @endif 
                                        </div>
                                    </div>
                                </div>
                            </div>
