                            ...
                            <div class="col-span-3 lg:col-span-1">
                                <div class="card bg-base-100 shadow-xl">
                                    <div class="card-body">
                                        ...
                                        <h5 class="flex">{{__('License')}} : @if(!empty($post->user->license)) {{$post->user->license}}@else {{__('This user didn\'t chose a license')}} @endif 
                                            <a wire:navigate class="hover:text-primary" href="{{route('about.licensing')}}" > 
                                                <svg class="ml-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                                    ...
                                    <div class="card bg-base-100 shadow-xl">
                                        <div class="card-body">
                                            ...
                                            <div class="text-center justify-center">
                                                <p>{{$post->user->bio}}</p>
                                                @if($post->user->social_network_link !== NULL)
                                                @php 
                                                $link = $post->user->social_network_link;
                                                @endphp
                                                <div class="flex justify-center">
                                                <a href="{{$post->user->social_network_link}}" class="">
