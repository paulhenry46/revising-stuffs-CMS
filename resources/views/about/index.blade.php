...
<div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
  ...
  <div class="card bg-base-100 shadow-xl">
                                    ...
                                    @endif
                                            ...
                                            <a wire:navigate class="btn btn-primary" href="{{route('users.public.view', $user->id)}}">{{__('See more about this user')}} <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M504-480 348-636q-11-11-11-28t11-28q11-11 28-11t28 11l184 184q6 6 8.5 13t2.5 15q0 8-2.5 15t-8.5 13L404-268q-11 11-28 11t-28-11q-11-11-11-28t11-28l156-156Z"/></svg></a> 
                                        </div>
                                    </div>
  @endforeach
  </div>

  <h2 class="mt-2 text-xl font-medium text-gray-900 dark:text-white">{{__('Contributors')}}</h2>
  <div class="mt-2 grid grid-cols-1 sm:grid-cols-4 gap-x-6 gap-y-2">
