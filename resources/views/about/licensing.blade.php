...
<div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
  ...
  Licenses give everyone a standardized way to grant the public permission to use their work under copyright law. 
  From the reuser’s perspective, the presence of a license on a copyrighted work answers the question, "What can I do with this work?".
  <br>In the profil settings, each user can chose what license he want to apply to his work. A lot of licenses are proposed, including :
  ...
  <h2 class="mt-2 text-xl font-medium text-gray-900 dark:text-white">CC BY-SA</h2>
    ...
    <h2 class="mt-2 text-xl font-medium text-gray-900 dark:text-white">The CC0 Public Domain Dedication</h2>
    CC0 (aka CC Zero) is a public dedication tool, which enables creators to give up their copyright and put their works into the worldwide public domain. 
    ...
    <h2 class="mt-2 text-xl font-medium text-gray-900 dark:text-white">Need help choosing your license ?</h2>
    If you don't know which license chose, you can user the <a href="https://creativecommons.org/choose/" class="link link-primary">CC License Chooser</a>.
  </div>
  From <a class="link link-primary" href="https://creativecommons.org/share-your-work/cclicenses/">Creative Commons Website</a>, under CC-BY License.
</div>
</div>
</div>
</div>
