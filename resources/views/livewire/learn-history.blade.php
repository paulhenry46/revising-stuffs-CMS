...
<div class="mt-6 mb-3 card bg-base-100 shadow-xl">
    <div class="card-body">
      <div class='flex justify-between'>
        ...
        <button wire:click='deleteAllSteps()' wire:confirm='Do you really want to delete all your progress ? ' class='btn btn-ghost'>
          <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="m656-120-56-56 84-84-84-84 56-56 84 84 84-84 56 56-83 84 83 84-56 56-84-83-84 83Zm-176 0q-138 0-240.5-91.5T122-440h82q14 104 92.5 172T480-200q11 0 20.5-.5T520-203v81q-10 1-19.5 1.5t-20.5.5ZM120-560v-240h80v94q51-64 124.5-99T480-840q150 0 255 105t105 255h-80q0-117-81.5-198.5T480-760q-69 0-129 32t-101 88h110v80H120Zm414 190-94-94v-216h80v184l56 56-42 70Z"/></svg>
        </button>
      </div>
        @if($steps->isEmpty())
  ...
  <table class="table table-zebra">
      ...
      <tr>
        <th>
            ...
            <div>
              ...
              <div class="font-bold">{{ $step->deck->deckable->title }}</div>
              
              <div class="text-sm opacity-50">{{ $step->deck->deckable->course->name }}</div>
            </div>
          </div>
        </th>
        <td>{{ $step->mastery }}</td>
    ...
    @else
    <a href="{{route('post.public.cards.quiz', [$step->deck->deckable->slug, $step->deck->deckable->id])}}" class="btn btn-ghost">
    <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M200-640h560v-80H200v80Zm0 0v-80 80Zm0 560q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-40q0-17 11.5-28.5T280-880q17 0 28.5 11.5T320-840v40h320v-40q0-17 11.5-28.5T680-880q17 0 28.5 11.5T720-840v40h40q33 0 56.5 23.5T840-720v187q0 17-11.5 28.5T800-493q-17 0-28.5-11.5T760-533v-27H200v400h232q17 0 28.5 11.5T472-120q0 17-11.5 28.5T432-80H200Zm520 40q-83 0-141.5-58.5T520-240q0-83 58.5-141.5T720-440q83 0 141.5 58.5T920-240q0 83-58.5 141.5T720-40Zm20-208v-92q0-8-6-14t-14-6q-8 0-14 6t-6 14v91q0 8 3 15.5t9 13.5l61 61q6 6 14 6t14-6q6-6 6-14t-6-14l-61-61Z"/></svg>
