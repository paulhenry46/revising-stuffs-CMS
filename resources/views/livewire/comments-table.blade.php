          ...
          <tbody class="divide-y divide-gray-200 dark:bg-gray-800 bg-white">
            ...
            <div class="pl-2 truncate text-sm font-medium leading-6 text-white">{{ $comment->user->name }}</div>
                ...
                <td class="flex items-stretch justify-end relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                  ...
                  <button x-on:click="$wire.validateComment({{ $comment->id }})" class="ml-4 text-green-600 hover:text-green-400">
                  ...
                  <button x-on:click="$wire.deleteComment({{ $comment->id }})" class="ml-4 text-red-600 hover:text-red-400">
            ...
            @empty
            <tr><td class="col-span-full">{{__('All comments are validated for now !')}}</td></tr>
            @endforelse
          </tbody>
        </table>
      </div>
