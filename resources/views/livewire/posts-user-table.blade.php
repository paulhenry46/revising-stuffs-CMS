      ...
      <div class="px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 flow-root">
          <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8"> @if($posts->isEmpty()) <div class="sm:col-span-4 rounded-box border-base-300 text-base-content/30 flex h-72 flex-col items-center justify-center gap-6 border-2 border-dashed p-10 text-center text-balance">
                <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                ...
                <tbody> @foreach($posts as $post) <tr>
                    ...
                    <td class="align-middle">
                      <div class="flex items-center whitespace-nowrap text-sm"> @if(($post->files->where('type', '=', 'primary light')->count() == 0) and (!$post->cards)) <div class="mr-2 text-error">
                          ...
                          </div> @endif @if($post->isCertified()) <div class="ml-2 text-success" title="{{ __('Certified') }}">
