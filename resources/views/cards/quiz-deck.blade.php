            ...
            <div class="p-6 lg:p-8 bg-base-200 dark:bg-base-200 border-b border-gray-200 dark:border-gray-700">
                    <div class="sm:flex sm:items-center">
                      <div class="sm:flex-auto">
                        <h1 class="text-2xl font-semibold leading-6 text-gray-900 dark:text-white">{{__('Cards')}} </h1>
                      </div>
...
<dialog id="my_modal_1" class="modal">
  <div class="modal-box">
    ...
    <p class="py-4">{{ __('Toogle recto/verso :') }} <button class="btn btn-primary"  
          @click="reverse()">
    ...
    <div class="modal-action">
      <form method="dialog">
        ...
        <button class="btn">{{__('Close')}}</button>
                        ...
                        <a wire:navigate href="{{route('decks.learn', [$deck->slug, $deck->id])}}" class=" ml-4 btn btn-primary">{{__('Learn mode')}}</a>
                        <a wire:navigate href="{{route('decks.show', [$deck->slug, $deck->id])}}" class=" ml-4 btn btn-primary">{{__('View')}}</a>
                      </div>
                    </div>
                </div>
